...
INSERT INTO SCRAMBLER VALUES
    ...
    ( 3, 'RUBIKS-CUBE-FRIDRICH-F2L-TRAINING',            'RUBIKS-CUBE',  'Fridrich - F2L training scrambler',            FALSE),
    ( 4, 'RUBIKS-CUBE-FRIDRICH-OLL-TRAINING',            'RUBIKS-CUBE',  'Fridrich - OLL training scrambler',            FALSE),
    ( 5, 'RUBIKS-CUBE-FRIDRICH-PLL-TRAINING',            'RUBIKS-CUBE',  'Fridrich - PLL training scrambler',            FALSE),
    ( 6, 'RUBIKS-CUBE-3OP-CORNERS-TRAINING',             'RUBIKS-CUBE',  '3OP - Corners training scrambler',             FALSE),
    ( 7, 'RUBIKS-CUBE-3OP-CORNERS-PERMUTATION-TRAINING', 'RUBIKS-CUBE',  '3OP - Corners permutation training scrambler', FALSE),
    ( 8, 'RUBIKS-CUBE-3OP-CORNERS-ORIENTATION-TRAINING', 'RUBIKS-CUBE',  '3OP - Corners orientation training scrambler', FALSE),
    ( 9, 'RUBIKS-CUBE-3OP-EDGES-TRAINING',               'RUBIKS-CUBE',  '3OP - Edges training scrambler',               FALSE),
    (10, 'RUBIKS-CUBE-3OP-EDGES-PERMUTATION-TRAINING',   'RUBIKS-CUBE',  '3OP - Edges permutation training scrambler',   FALSE),
    (11, 'RUBIKS-CUBE-3OP-EDGES-ORIENTATION-TRAINING',   'RUBIKS-CUBE',  '3OP - Edges orientation training scrambler',   FALSE),
    ...
    (14, 'RUBIKS-CUBE-EASY-CROSS',                       'RUBIKS-CUBE',  'Easy cross scrambler',                         FALSE),
    ...
    (-1, 'RUBIKS-DOMINO-IMPORTER',                       'TOWER-CUBE',   'Importer scrambler',                            TRUE),
    ( 0, 'RUBIKS-DOMINO-RANDOM',                         'TOWER-CUBE',   'Random scrambler',                             FALSE),
